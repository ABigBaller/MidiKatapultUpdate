...
void display(int x, int y, int lcolor) {
  ...
  println("setSquare");}
    ...
    else if (lcolor == REDL) fill(127, 0, 0, o);
    else if (lcolor == GREEN) fill(0, 255, 0, o);
    else if (lcolor == GREENL) fill(0, 127, 0, o);
    else if (lcolor == AMBER) fill(255, 127, 0, o);
    else if (lcolor == AMBERL) fill(127, 63, 0, o);
    else if (lcolor == YELLOW) fill(255, 255, 0, o);
    
    else if (lcolor == BLUE) fill(0, 0, 255, o);
    else if (lcolor == BLUEL) fill(0, 0, 127, o);
    else if (lcolor == CYAN) fill(0, 255, 255, o);
   else  if (lcolor == CYANL) fill(0, 127, 127, o);
    else if (lcolor == MAGENTA) fill(255, 0, 255, o);
    else if (lcolor == MAGENTAL) fill(127, 0, 127, o);
   else  if (lcolor == WHITE) fill(230, 230, 230, o);
    else if (lcolor == WHITEL) fill(180, 180, 200, o);
